        ...
        <div>
            ...
            <main>
                <form action='https://formspree.io/f/xeojywpl' method="POST" className="reservation-form">
                  <h2 className="form-title">Dessert</h2>
                    ...
                    <div className="form-group">
                        ...
                        <select name="Place" className="form-input" required>
                            ...
                            <option value="sunday_folks">Sunday Folks</option>
                            <option value="sweet_cheeks">Sweet Cheeks</option>
                            <option value="apiary">Apiary</option>
                            <option value="2am_dessert_bar">2am:Dessert Bar</option>
                            <option value="around">Around</option>
                            <option value="ah_crew_dessert">Ah Crew Dessert</option>
                            <option value="tsujiri">Tsujiri</option>
                            <option value="kooks_creamery">Kooks Creamery</option>
                            <option value="roji_monster_ice_cream">Roji Monster Ice Cream</option>
                            <option value="flor_patisserie">FLOR Patisserie</option>
                            <option value="birds_of_paradise">Birds of Paradise</option>
                            <option value="bread_butterfly">Bread & Butterfly</option>
                            <option value="monarchs_milkweed_gelato">Monarchs & Milkweed Gelato</option>
                            <option value="hvala">Hvala</option>
                        </select>
                    </div>
                    <div className="form-group">
