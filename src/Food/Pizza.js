        ...
        <div>
            ...
            <main>
                <form action='https://formspree.io/f/xeojywpl' method="POST" className="reservation-form">
                  <h2 className="form-title">Pizza</h2>
                    ...
                    <div className="form-group">
                        ...
                        <select name="Place" className="form-input" required>
                            ...
                            <option value="pizzaface">Pizzaface</option>
                            <option value="chooby_pizza">Chooby Pizza</option>
                            <option value="yellow_crab_pizza">Yellow Crab Pizza</option>
                            <option value="pepperoni_pizzaria">Pepperoni Pizzaria</option>
                            <option value="publico_ristorante">Publico Ristorante</option>
                            <option value="blue_labal_pizza_wine">Blue Labal Pizza & Wine</option>
                        </select>
                    </div>
                    <div className="form-group">
