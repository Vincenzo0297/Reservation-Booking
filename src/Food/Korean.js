        ...
        <div>
            ...
            <main>
                <form action='https://formspree.io/f/xeojywpl' method="POST" className="reservation-form">
                  <h2 className="form-title">Korean</h2>
                    ...
                    <div className="form-group">
                        ...
                        <select name="Place" className="form-input" required>
                            ...
                            <option value="obba_jajang">Obba Jajang</option>
                            <option value="itaewon_jajang">Itaewon Jajang</option>
                            <option value="kimchi_restaurant">Kimchi Restaurant</option>
                            <option value="hanwoori_korean_restaurant">Hanwoori Korean Restaurant</option>
                            <option value="big_mama">Big Mama</option>
                        </select>
                    </div>
                    <div className="form-group">
