        ...
        <div>
            ...
            <main>
                <form action='https://formspree.io/f/xeojywpl' method="POST" className="reservation-form">
                  <h2 className="form-title">Pasta</h2>
                    ...
                    <div className="form-group">
                        ...
                        <select name="Place" className="form-input" required>
                            ...
                            <option value="tipo">Tipo Pasta Bar</option>
                            <option value="fresca">Pasta Fresca Da Salvatore</option>
                            <option value="bar">Pasta Bar</option>
                        </select>
                    </div>
                    <div className="form-group">
